...
import bg from "@/assets/bg-login2.jpg"
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground">
                  {isLogin
                    ? "Login to your k-services account"
              ...
              <div className="relative text-center text-sm text-muted-foreground">
                <div className="absolute inset-0 top-1/2 z-0 flex items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* Apple */}
                <Button variant="outline" className="w-full p-0 flex items-center justify-center">
